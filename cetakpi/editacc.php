  ...
  <div class="gg">
    ...
    <?php
      ...
      if(mysqli_num_rows($result)==1)
      {
        ...
        {
        echo "<form method='post' action='saveeditacc.php'>
        <table>";
        echo "<tr>";
        echo "<td class='aa'>Name :</td>";
        echo "<td><input type='text' name='fname' placeholder=".$row['fullname']." required>";
        
        echo "</tr>";
        echo "<tr>";
        echo "<td class='aa'>Address :</td>";
        echo "<td><input type='textarea' name='address' placeholder=".$row['addr']." required>";
        echo "</tr><tr>";
        echo "</tr>";
         echo "<td class='aa'>No tel. :</td>";
        echo "<td><input type='text' name='tel' placeholder=".$row['tel']." required>";
        echo "<tr>";
        echo "</tr>";
         echo "<td class='aa'>Username :</td>";
        echo "<td><input type='text' name='user' placeholder=".$row['uname']." required>";
        echo "<tr>";
        echo "</tr>";
        echo "<tr>";
         echo "<td class='aa'>Password :</td>";
        echo "<td><input type='text' name='pass' placeholder=".$row['passw']." required>";
        echo "</tr>";
        echo "</table><br><br>
